...
proyectos = st.sidebar.selectbox(
        "Opciones",
        options=["OPCIONES", "FILTRADOR ALMACEN", "CALENDARIO ALMACEN", "CREAR GUIA RUTA LA PAZ", "CHECK FILEWEB AND LASERFICHE", "SINTAXIS LASERFICHE-ONEIL", "JUEGA CON DINO"]
    )
...
if proyectos == "OPCIONES":
    ...
    figlet = Figlet(font='banner3-D')  # Puedes probar 'standard', 'big', 'banner3-D', etc.
